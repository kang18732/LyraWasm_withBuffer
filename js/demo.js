...
const tenMilliSecondFramesCount = 8;  // Lyra encodes/decodes in frames of 40ms.
let main_buffer = new Float32Array(tenMilliSecondFramesCount*480);
let copy_index = 0;
let num_copied = 0;
let start_time = 0;
...
function encodeAndDecode() {
    return (audiodata, controller) => {
        ...
        if (!isLyraCodecReady || !isLyraEnabled) {
            ...
            if (num_copied == tenMilliSecondFramesCount) {
