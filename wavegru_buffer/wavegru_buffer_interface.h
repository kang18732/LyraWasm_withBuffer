#ifndef LYRA_CODEC_WAVEGRU_BUFFER_INTERFACE_H_
#define LYRA_CODEC_WAVEGRU_BUFFER_INTERFACE_H_
...
// Encapsulates wavegru models that have been read from a source and loaded into
...
class SimpleWavegruBuffer : public WavegruBufferInterface {
 public:
  SimpleWavegruBuffer(
...
#endif  // LYRA_CODEC_WAVEGRU_BUFFER_INTERFACE_H_